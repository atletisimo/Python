...
if __name__ == '__main__':
    ...
    rang_pearson=rank_documents(text,documents,pearson)[:4]
    rang_cosine = rank_documents(text, documents, cosine)[:4]
    brojac=0
    for i,r_cosine,r_pearson in zip (range(4),rang_cosine,rang_pearson):
    ...
    print ("Rang po slicnost:{} Cosine-Document #{} Pearson-Document #{}".format(i,cosine_index,pearson_index))
    print("Dvete metriki davaat ist rezultat:{}".format(brojac))
